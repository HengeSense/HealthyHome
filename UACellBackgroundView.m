...
@implementation UACellBackgroundView
    ...
    - (void)setTopColor:(UIColor *)topColor {
        if (_topColor != topColor) {
            ...
            colorComponents_[0] = topColor.red;
            colorComponents_[1] = topColor.green;
            colorComponents_[2] = topColor.blue;
            colorComponents_[3] = topColor.alpha;
    ...
    - (void)setBottomColor:(UIColor *)color {
        if (_topColor != color) {
            ...
            colorComponents_[4] = color.red;
            colorComponents_[5] = color.green;
            colorComponents_[6] = color.blue;
            colorComponents_[7] = color.alpha;
