...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //Other Tab
    HISecondViewController *secondController;
...
//        viewController1 = [[HIFirstViewController alloc] initWithNibName:@"HIFirstViewController_iPad" bundle:nil];
//        viewController2 = [[HISecondViewController alloc] initWithNibName:@"HISecondViewController_iPad" bundle:nil];
