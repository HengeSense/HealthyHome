...
@property(strong, nonatomic) CheckListQuestionAnswers *answer;
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
    ...
    if (self) {
        ...
        self.infoButton.hidden = ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad);
...
- (IBAction)NotesClicked {
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
        ...
        CGRect r = CGRectMake(self.view.bounds.size.width / 2 - 236, 0, 472, 400);
        r = [self.view convertRect:r toView:nc.view.superview.superview];
        nc.view.superview.frame = r;
