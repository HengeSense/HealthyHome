//
//  HIAssestsReportTableViewController.m
//  HealthyInteriors
//
...
@interface HIAssestsReportTableViewController ()

@end

@implementation HIAssestsReportTableViewController
    ...
    - (void)viewDidLoad {
        ...
        self.navigationItem.title = @"Assets Report";
